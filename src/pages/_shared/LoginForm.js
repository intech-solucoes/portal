    ...
    render() {
        return (
            <form>
                ...
                {this.state.mensagem !== "" && <Alert id={"alerta-info"} tipo={"info"} mensagem={this.state.mensagem} />}
                {this.state.erro !== "" && <Alert id={"alerta-erro"} tipo={"danger"} mensagem={this.state.erro} />}
